...
const DEVICE_TAPPED = 'DeviceState/DEVICE_TAPPED';
...
export function tagTapped(data) {
    ...
    return (dispatch, getState) => {
        ...
        if (taggeddevices.length <= 0){
            console.log("navigatinbg to tag devices!");
            navigation.navigate("TagDevices",{});
        }else{
            console.log("navigating to monitor devcies");
